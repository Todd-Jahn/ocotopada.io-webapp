  ...
  const characters = [
    {
      ...
      avatar: "https://images.unsplash.com/photo-1494790108755-2616b169ad8a/RicGfHP6MTg?w=400&h=500&fit=crop&crop=center",
    ...
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d/kJDqiOGrX4k?w=400&h=500&fit=crop&crop=center",
    ...
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80/JGpWEZ9AYDs?w=400&h=500&fit=crop&crop=center",
    ...
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e/MrHCr0GwUq0?w=400&h=500&fit=crop&crop=center",
    ...
    },
    {
      ...
      avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2/V_CgXwfok8E?w=400&h=500&fit=crop&crop=center",
                ...
                <div className="overflow-hidden rounded-2xl">
                  ...
                  >
                    {characters.map((character, index) => (
                      ...
                      >
                        <div className="bg-white/10 backdrop-blur-lg rounded-2xl overflow-hidden border border-white/20 h-full">
                          {/* 完整照片框架 */}
                          <div className="relative h-64">
                            ...
                            <div className="absolute bottom-4 left-4 text-white">
                              ...
                              <p className="text-purple-300 font-semibold">{character.personality}</p>
                            </div>
                            
                            {/* 颜色指示器在右上角 */}
                            <div className={`absolute top-4 right-4 w-5 h-5 bg-gradient-to-r ${character.color} rounded-full border-2 border-white shadow-lg`}></div>
                          </div>
                          
                          {/* 描述区域 */}
                          <div className="p-4">
                            <p className="text-sm text-gray-300 leading-relaxed text-center">{character.description}</p>
                          </div>
                        </div>
                      </motion.div>
                    ))}
